...
def main(args):
    ...
    # images_folder_path = f'./results/allsight_distil_{args.cgan_num}/test_{args.cgan_epoch}/images/'
    ...
    json_sim_p = r'C:\Users\roblab20\Documents\yardenalon\Compression\datasets\Finger\json_data\sim_train_3_transformed_fixed.json'
    json_gan_name = 'SRC_Gin_3'
    images_folder_path = r'C:\Users\roblab20\Documents\yardenalon\Single-modal\results\exp_Finger2\test_latest\images\fake_B'
    copy_to_path = r'C:\Users\roblab20\Documents\yardenalon\Compression\datasets\Finger\SRC'
    JSON_FILE = r'C:\Users\roblab20\Documents\yardenalon\Compression\datasets\Finger\json_data\{}'.format(json_gan_name)
    ...
    new_images_paths = [img for img in images_p]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='', help='cgan, distil_cgan')
